...
def DOE(DOE_RunNumber, DOE_dense_1, DOE_dense_2, DOE_dropout, DOE_learning_rate, DOE_EPOCH, DOE_batch_size, DOE_DECAY):
    ...
    for i in range(0, 4):
        ...
        m_history = model_full(df_data_path, dense_1 = DOE_dense_1, dense_2=DOE_dense_2, dropout=DOE_dropout, learning_rate=DOE_learning_rate, epoch=DOE_EPOCH,
                               batch_size=DOE_batch_size, DECAY=DOE_DECAY, checkpoint_fpath=checkpoint,
...
if __name__ == '__main__':
    ...
    # RUN 2
    DOE(DOE_RunNumber = 2, DOE_dense_1=128, DOE_dense_2=32, DOE_dropout=.1, DOE_learning_rate=3e-6, DOE_EPOCH=2, DOE_batch_size=64, DOE_DECAY=.01)
    # RUN 3
